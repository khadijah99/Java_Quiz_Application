...
public class DeleteTestFrame extends JFrame {
	public DeleteTestFrame(ArrayList<Test> t) {
		...
		JLabel l1,l2,l3;
			...
			c2 = new JComboBox ();
			  ...
			  JLabel background = new JLabel(new ImageIcon(new ImageIcon("E:\\Project\\registerbg2.jpg").getImage().getScaledInstance(800, 500, Image.SCALE_SMOOTH)));
		        add(background);
			...
			b1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int x = 0 ; x < t.size() ; x++ ) {
						...
						DeleteTestFrame.this.dispose();
					new DeleteTestFrame(t);
